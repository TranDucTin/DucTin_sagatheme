<section class="wrap 2xl:flex xl:w-4/5 xl:flex-none xl:justify-center mx-auto mt-25">
  ...
  <div class="info 2xl:w-3/5 xl:w-full xl:flex lg:flex-none lg:mx-auto">
      <div class="column1 mr-2.5 xl:w-1/2 md:w-3/4 md:mx-[auto]">
        ...
        <p>
          ...
          Capture mission-critical data across your entire operation—including all
